...
export const SECTIONS: SectionData[] = [
  ...
  [
    ...
    [
      ...
      [B_LAUNCHER, 18, 607, 0, -1, 1450, 36],
      [B_FIELD, 6, 514, 15, 108, TRIGGER_DEACTIVATE_WALL, 41, 0, 1000],
      [B_FIELD, 15, 517, 16, 110, TRIGGER_DEACTIVATE_WALL, 42, 0, 1000],
      ...
      [B_FAN, 135, 97, 4, 1, 72, 0, 0, -1.35],
      [B_CONVEYER, 217, 13, 34, 191, -1.5708, 900, 900, 4],
      [B_COLLECTABLE, 111, 76, 10, 0, TRIGGER_GATE_SECTION_4],
